...
//		return isValid;
		...
		//String regex="(?:(\\(\\+?86\\))(0[0-9]{2,3}\\-?)?([2-9][0-9]{6,7})+(\\-[0-9]{1,4})?)|(?:(86-?)?(0[0-9]{2,3}\\-?)?([2-9][0-9]{6,7})+(\\-[0-9]{1,4})?)";
		String regex="^(0\\d{2,3}\\-)?([2-9]\\d{6,7})+(\\-\\d{1,6})?$";
