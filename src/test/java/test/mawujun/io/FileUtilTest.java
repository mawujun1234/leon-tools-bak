...
import com.mawujun.io.file.LineSeparator;
...
public class FileUtilTest {
	...
	public void loopFilesTest() {
		List<File> files = FileUtil.listLoopFiles("d:/");
		for (File file : files) {
	...
	public void extNameTest() {
		String path = "d:\\aaa\\bbb\\cc\\ddd\\";
		String mainName = FileUtil.getSuffixName(path);
		Assert.assertEquals("", mainName);

		path = "d:\\aaa\\bbb\\cc\\ddd";
		mainName = FileUtil.getSuffixName(path);
		Assert.assertEquals("", mainName);
	...
	public void getWebRootTest() {
		...
		Assert.assertEquals("leon-tools", webRoot.getName());
	}
